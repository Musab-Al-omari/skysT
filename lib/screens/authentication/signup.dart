...
class SignUpPage extends StatefulWidget {
  static const SignUpPageScreenRoute = '/SignUpPage-Screen';
...
//   RigesterForm(this.userName, this.email, this.password, this.phoneNumber);
// }
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget _loginAccountLabel() {
    return InkWell(
      onTap: () {
        Navigator.pushReplacementNamed(context, '/LoginPagePage-Screen');
      },
      child: Container(
